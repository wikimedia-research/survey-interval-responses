...
In this post, we present a model and we demonstrate its application through the example of inferring the median task completion time based on an imaginary survey in which the non-linearly scaled options were:
