...
In this post, we present a model and its extension -- and we demonstrate their applications through the example of inferring the median task completion time based on an imaginary survey in which the non-linearly scaled options were:
